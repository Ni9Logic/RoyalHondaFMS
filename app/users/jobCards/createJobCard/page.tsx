...
export default function Page() {
    ...
    const [GSTR, setGSTR] = useState<string>('');
                                                        ...
                                                        <Drawer>
                                                            ...
                                                            <DrawerContent>
                                                                <DrawerHeader className="flex items-center flex-col gap-2">
                                                                    ...
                                                                    <DrawerDescription className="justify-center flex flex-col gap-1">
                                                                        <Input required form="form2" placeholder="Company Name" onChange={(e) => setValue('name', e.target.value)} />
                                                                        <Input required form="form2" placeholder="Company NTN" onChange={(e) => {
                                                                            setValue('NTN', e.target.value);
                                                                            setNTN(e.target.value);
                                                                        }} />
                                                                        <Input form="form2" placeholder="Company GSTR" onChange={(e) => {
                                                                            setValue('GSTR', e.target.value);
                                                                            setGSTR(e.target.value);
                                                                        }} />
                                                                    </DrawerDescription>
                                                                </DrawerHeader>
                                                                <DrawerFooter className="flex justify-center items-center">
                                                                    <Button className="w-20 flex flex-row gap-1" type="submit" form="form2" disabled={isAddInsuranceLoading}>
                                                                        Add
