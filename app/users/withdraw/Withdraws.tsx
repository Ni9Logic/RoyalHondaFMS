...
const createTransaction = async (amount: number, email: string, transactionType = "Withdraw") => {
    try {
...
const Withdraws: React.FC<WithdrawProps> = ({currentUser}) => {
    ...
    const onSubmit: SubmitHandler<FormValues> = async (data: FormValues) => {
        try {
            ...
            const update = await withdraw(Number(data.amount), currentUser?.email as string);
