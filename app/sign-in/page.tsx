            ...
            <div className='flex flex-col items-center justify-center h-screen'>
                ...
                <form onSubmit={handleSubmit(onSubmit)}>
                    <div className="text-left">
                        ...
                        <label htmlFor="helper-text" {...register('password')} className="flex flex-col my-2 mb-2 text-sm font-medium text-gray-900 dark:text-white">Your Password</label>
                    ...
                    <button type="submit" className="gap-10 my-10 px-20 text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm py-2.5 mr-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">Login</button>
                </form>
            </div>
        </>
    );
