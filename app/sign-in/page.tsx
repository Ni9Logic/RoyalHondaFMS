    ...
    return (
        <>
            ...
            <div className='flex flex-col items-center justify-center gap-10 h-[80vh]'>
                <div className='h-96 justify-center items-center grid grid-cols-2'>
                    <div className='container border border-black border-l-0 border-t-0 border-b-0'>
                        <Label className='flex justify-center mb-5 text-xl font-bold'>Sign In</Label>
                    ...
                    <div className='flex flex-col w-full '>
                        ...
                        <h1 className='mt-2 font-bold text-xl text-red-500 ml-9'>ROYAL HONDA</h1>
                    </div>
                </div>
            </div>
        </>
